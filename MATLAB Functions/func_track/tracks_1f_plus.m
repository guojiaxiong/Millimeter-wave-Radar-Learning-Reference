function current_points = tracks_1f_plus(detections, costThreshold, predictionframe, reset)
    % 输入参数:
    %   current_points  currenttracks
    ...
    current_points = [];
    for i = 1:length(tracks)
        current_points(i,:)  = [tracks(i).id tracks(i).x(1:2)'];%detections(i, 1)
    end
end